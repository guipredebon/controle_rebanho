...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/grupos', [GrupoVacaController::class, 'index'])->name('grupos.index');
    Route::get('/grupos/create', [GrupoVacaController::class, 'create'])->name('grupos.create');
    Route::post('/grupos', [GrupoVacaController::class, 'store'])->name('grupos.store');
    Route::get('/grupos/{grupo}', [GrupoVacaController::class, 'show'])->name('grupos.show');
    Route::get('/grupos/{grupo}/edit', [GrupoVacaController::class, 'edit'])->name('grupos.edit');
    Route::put('/grupos/{grupo}', [GrupoVacaController::class, 'update'])->name('grupos.update');
    Route::delete('/grupos/{grupo}', [GrupoVacaController::class, 'destroy'])->name('grupos.destroy');
